...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference("Field.count") do
      post fields_url, params: { field: { field__name: @field.field__name, subject_id: @field.subject_id } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { field__name: @field.field__name, subject_id: @field.subject_id } }

...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { question_id: @exam.question_id, sentence: @exam.sentence } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { question_id: @exam.question_id, sentence: @exam.sentence } }
